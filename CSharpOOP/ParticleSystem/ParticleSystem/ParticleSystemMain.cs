    ...
    class ParticleSystemMain
    {
        ...
        static void Main()
        {
            ...
            var particles = new List<Particle>()
            {
                ...
                //new ChickenParticle(new MatrixCoords(15,5), new MatrixCoords(1,1), RandomGenerator, tickMiliSecs, chickenStopToCreate)
                new ParticleRepeller(new MatrixCoords(15,10),new MatrixCoords(0,0), 20)
            };
